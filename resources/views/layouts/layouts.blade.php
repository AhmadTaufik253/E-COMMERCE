...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Horizontal | webadmin - Admin & Dashboard Template</title>
            ...
            <header class="ishorizontal-topbar">
                <div class="navbar-header">
                    ...
                    <div class="">
                        ...
                        @if(auth()->check())
                        <div class="dropdown d-inline-block">
                            <button type="button" id="cartButton" class="btn header-item noti-icon">
                        ...
                        @if(auth()->check()) 
                            <div class="dropdown d-inline-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-end pt-0">
                                    ...
                                    document.getElementById('logout-form').submit();"><i class="mdi mdi-logout text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Logout</span></a>
                        ...
                        @else
                            <div class="d-inline-block">
                                <a href="{{ route('login') }}" class="btn btn-primary align-items-center">Login</a>
                                <a href="{{ route('register') }}" class="btn btn-primary align-items-center">Register</a>
                            </div>
                        @endif
    ...
    <script>
        $(document).ready(function () {
            $("#cartButton").on("click", function () {
                window.location.href = "/cart"; // Ganti dengan URL yang diinginkan
            });
        });
    </script>
