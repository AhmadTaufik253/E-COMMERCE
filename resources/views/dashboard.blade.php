                                ...
                                <div class="card">
                                    ...
                                    <div>
                                        <div class="custom-accordion p-4">
                                            <h5 class="font-size-14 mb-0"><a href="#categories-collapse" class="text-dark d-block" data-bs-toggle="collapse">Categories <i class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                                         
                                            <div class="collapse show mt-4" id="categories-collapse">
                                                <div class="categories-group-card">
                                                    <a href="#collapseOne" class="text-body fw-semibold pb-3 d-block collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseOne">
                                                        <i class="bx bx-desktop font-size-16 align-middle me-2"></i> Electronic
                                                ...
                                                <div class="categories-group-card">
                                                    <a href="#collapseTwo" class="text-body fw-semibold pb-3 d-block" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapseTwo">
                                                ...
                                                <div class="categories-group-card">
                                                    <a href="#collapseThree" class="text-body fw-semibold pb-3 d-block collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseThree">
                                                        <i class="bx bx-command font-size-16 align-middle me-2"></i> Baby & Kids
                                                        <i class="mdi mdi-chevron-up float-end accor-down-icon"></i>
                                                    </a>
                                                ...
                                                <div class="categories-group-card">
                                                    <a href="#collapseFour" class="text-body fw-semibold pb-3 d-block collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseFour">
                                                        <i class="bx bx-dumbbell font-size-16 align-middle me-2"></i> Fitness
                                                        <i class="mdi mdi-chevron-up float-end accor-down-icon"></i>
                                                    </a>
                                        ...
                                        <div class="custom-accordion">
                                            ...
                                            <div class="p-4 border-top">
                                                <div>
                                                    <h5 class="font-size-14 mb-0"><a href="#filterproduct-discount-collapse" class="text-dark d-block" data-bs-toggle="collapse">Discount <i class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                                                        ...
                                                        <div class="col-xl-11 col-lg-11">
                                                           <div class="row align-items-center">
                                                            <div class="col-md-6">
                                                             ...
                                                             <div class="col-md-6">
                                                               <div class="p-4 p-xl-0">
                                                                    <h3 class="mb-2 text-truncate"><a href="/product-detail">Tuition Classes Chair Crime </a></h3>
                                                                    <h5 class="fw-normal font-size-16 mt-1 text-truncate">SKU: Fluid HB - Lite - AN White</h5>
                                                                    <ul class="list-unstyled px-0 mb-0 mt-4">
                                                                        <li><p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle me-1"></i> 3 Year Warranty and Stock Available</p></li>
                                                                        <li><p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle me-1"></i> Material : Steel + PVC Leather + Sponge</p></li>
                                                                        </ul>
                                                                    <h2 class="mb-0 mt-4 text-truncate"><span class="font-size-20">Form</span><b> $2,360</b> <span class="text-muted me-2"><del class="font-size-20 fw-normal">$3500</del></span></h2>
                                                                    <div class="mt-4">
                                                        ...
                                                        <div class="col-xl-11 col-lg-11">
                                                           <div class="row align-items-center">
                                                            <div class="col-md-6">
                                                             ...
                                                             <div class="col-md-6">
                                                               <div class="p-4 p-xl-0">
                                                                    <h3 class="mb-2 text-truncate"><a href="/product-detail">Home & Office Chair Crime </a></h3>
                                                                    <h5 class="fw-normal font-size-16 mt-1 text-truncate">SKU: Fluid HB - Lite - AN Grey</h5>

                                                                    <ul class="list-unstyled px-0 mb-0 mt-4">
                                                                        <li><p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle me-1"></i> Material : Steel + PVC Leather + Sponge</p></li>
                                                                        <li><p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle me-1"></i> Overall Dimention : 16.5" x 19.5" x 24.3" (L x W x H)</p></li>
                                                                    </ul>
                                                        ...
                                                        <div class="col-xl-11 col-lg-11">
                                                           <div class="row align-items-center">
                                                            <div class="col-md-6">
                                                             ...
                                                             <div class="col-md-6">
                                                               <div class="p-4 p-xl-0">
                                                                    <h3 class="mb-2 text-truncate"><a href="/product-detail">Hotel Dining Table And Chair</a></h3>
                                                                    <h5 class="fw-normal font-size-16 mt-1 text-truncate">SKU: Fluid HB - Lite - AN Dark</h5>
                                                                    <ul class="list-unstyled px-0 mb-0 mt-4">
                                                                        <li><p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle me-1"></i> Choose From Standard , Express Or Assembled Services</p></li>
                                                                        <li><p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle me-1"></i> 3 Year Warranty and Stock Available</p></li>
                                                                    </ul>
                                                                    <h2 class="mb-0 mt-4 text-truncate"><span class="font-size-20">Form</span><b> $2,360</b> <span class="text-muted me-2"><del class="font-size-20 fw-normal">$3500</del></span></h2>
                                                                    <div class="mt-4">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            ...
                                            <ul class="nav nav-tabs nav-tabs-custom mt-3 mb-2 ecommerce-sortby-list">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#popularity" role="tab" href="#">Popularity</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#newest" role="tab" href="#">Newest</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#discount" role="tab" href="#">Discount</a>
                                                </li>
                                            </ul>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Black, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-dark font-size-16">Sofa Home Chair Black</a></h5>
                                                                        <p class="text-muted mb-0">
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                        ...
                                                                        <h5 class="font-size-20 text-primary mt-3 mb-0">$180 <del class="text-muted font-size-15 fw-medium ps-1">$200</del></h5>     
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-content pt-3">
                                                                        ...
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-dark font-size-16">Tuition Classes Chair Crime</a></h5>
                                                                        <p class="text-muted mb-0">
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                        ...
                                                                        <h5 class="font-size-20 text-primary mt-3 mb-0">$410 <del class="text-muted font-size-15 fw-medium ps-1">$340</del></h5>     
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-dark font-size-16">Dining Table And Chair</a></h5>
                                                                        <p class="text-muted mb-0">
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
