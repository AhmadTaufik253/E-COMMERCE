                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle mb-0 table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th><img src="./assets/images/product/img-1.png" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-dark">Home & Office Chair Crime </a></h5>
                                                    ...
                                                    <tr>
                                                        <th><img src="./assets/images/product/img-2.png" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <th><img src="./assets/images/product/img-5.png" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-dark">Tuition Classes Chair Crime</a></h5>
                                                    ...
                                                    <tr>
                                                        <th><img src="./assets/images/product/img-7.png" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-dark">Dining Table And Chair</a></h5>
                                                    ...
                                                    <tr>
                                                        <th><img src="./assets/images/product/img-8.png" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-dark">Home & Office Chair Crime</a></h5>
